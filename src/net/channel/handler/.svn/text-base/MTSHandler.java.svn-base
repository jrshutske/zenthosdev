                ...
                if (i.getQuantity() > 0 && i != null && c.getPlayer().getMeso() >= 1337) {
                    ...
                    try {
                        ...
                        if (i.getType() == 2) {
                            ...
                            Equip equip = (Equip) i;
                            ps = con.prepareStatement("INSERT INTO mts_items (tab, type, itemid, quantity, seller, price, upgradeslots, level, str, dex, `int`, luk, hp, mp, watk, matk, wdef, mdef, acc, avoid, hands, speed, jump, vicious, flag, itemexp, owner, sellername, sell_ends) VALUES " +
                            "(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                            ps.setInt(1, 1);
                            ...
                            ps.setInt(24, equip.getVicious());
                            ps.setInt(25, equip.getFlag());
                            ps.setInt(26, equip.getItemExp());
