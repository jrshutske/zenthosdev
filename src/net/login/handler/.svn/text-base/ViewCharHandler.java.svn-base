...
public class ViewCharHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        try {
            PreparedStatement ps = con.prepareStatement("SELECT id, world FROM characters WHERE accountid = ? ORDER BY world ASC, id ASC");
            ...
            System.out.println("Viewing all chars failed: " + e);
        }
    }
}