    ...
    public void run(MapleCharacter c, Integer extSelection) {
        ...
        switch (type) {
            case EXP:
                ...
                c.gainExp(MapleDataTool.getInt(data) * ServerProperties.getExpRate, true, true);
                break;
            case ITEM:
                ...
                for (MapleData iEntry : data.getChildren()) {
                    ...
                    if (MapleDataTool.getInt(iEntry.getChildByPath("count")) < 0) {
                        ...
                        try {
                            ...
                            System.out.println("[h4x] Completing a quest without meeting the requirements: " + ie);
                        }
            ...
            case SKILL:
                for (MapleData sEntry : data) {
                    ...
                    if (shouldLearn) {
                        ...
                        c.dropMessage("You have learned " + SkillFactory.getSkillName(skillid) + " with level " + skillLevel + " and with max level " + masterLevel);
                    }
                }
                break;
            case FAME:
