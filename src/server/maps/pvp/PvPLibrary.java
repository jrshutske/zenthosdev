        ...
        for (int dmgpacket = 0; dmgpacket < attack.numDamage; dmgpacket++) {
            TimerManager.getInstance().schedule(new Runnable() {
                ...
                public void run() {
                    ...
                    player.getClient().getSession().write(MaplePacketCreator.damagePlayer(attack.numDamage, pvpMob.getId(), attackedPlayers.getId(), pvpDamage, 0, 0, false, 0, false, 0, 0, 0));
