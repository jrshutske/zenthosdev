...
public class Marriage {
    public static void createMarriage(MapleCharacter player, MapleCharacter partner) {
        try {
            ...
            System.out.println("Problem marrying " + player.getName() + " and " + partner.getName() + ex);
        }
    }
    ...
    public static void createEngagement(MapleCharacter player, MapleCharacter partner) {
        try {
            ...
            System.out.println("Problem announcing engagement with " + player.getName() + " and " + partner.getName() + ex);
        }
    }
    ...
    public static void divorceEngagement(MapleCharacter player) {
        try {
            ...
            System.out.println("Problem divorcing" + player.getName() + " and his or her partner" + ex);
        }
    }
