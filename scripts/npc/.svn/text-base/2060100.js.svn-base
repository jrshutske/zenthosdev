//carta
function start(){
var quast = Packages.server.quest.MapleQuest.getInstance(6301);
if(cm.getChar().getQuest(quast).getStatus().equals(Packages.client.MapleQuestStatus.Status.STARTED)){
//4000175
